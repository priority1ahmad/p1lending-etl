...
class TestConfigurationSecurity:
    ...
    def test_config_requires_secret_key(self):
        ...
        try:
            ...
            assert 'secret_key: str = Field(...' in source or 'secret_key: str = Field(...)' in source.replace(' ', ''), \
    ...
    def test_snowflake_credentials_required(self):
        ...
        assert 'private_key_password: str = Field(...' in source, "SNOWFLAKE_PRIVATE_KEY_PASSWORD should be required"
    ...
    def test_snowflake_secure_defaults(self):
        ...
        assert 'insecure_mode: bool = Field(default=False' in source, \
            "insecure_mode should default to False"
        assert 'ocsp_fail_open: bool = Field(default=False' in source, \
    ...
    def test_idicore_credentials_required(self):
        ...
        assert 'client_secret: str = Field(...' in source, "IDICORE_CLIENT_SECRET should be required"
...
class TestCelerySerializationSecurity:
    ...
    def test_celery_does_not_accept_unsafe_content(self):
        ...
        assert not unsafe_formats.intersection(accepted), \
    ...
    async def test_blacklist_token(self):
        ...
        with patch('app.core.token_blacklist.aioredis') as mock_redis:
            ...
            mock_conn.setex.assert_called_once_with(
                "token_blacklist:test-jti-123", 300, "1"
            )
