...
class PhoneBlacklist(Base):
    ...
    source_table_id = Column(String(255), nullable=True)  # The table_id from which this was blacklisted
    source_job_id = Column(UUID(as_uuid=True), ForeignKey("etl_jobs.id", ondelete="SET NULL"), nullable=True)
