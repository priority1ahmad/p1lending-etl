...
class ETLLogger:
    ...
    def __init__(
        self, name: str = "ETL", level: Optional[str] = None, log_file: Optional[str] = None
    ):
        """
    ...
    def __init__(
        ...
        if job_id:
            ...
            try:
                ...
                log_dir.mkdir(parents=True, exist_ok=True)
                self.logger.warning(
                    f"Could not create log directory at {get_logs_dir()}, using {log_dir} instead"
                )
